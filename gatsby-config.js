...
module.exports = {
  ...
  siteMetadata: {
    ...
    typing: [`Software Engineer`,`UI Designer`,`UX Enthusiast`,`Frontend Developer`,`Web Developer`, `Web Designer`],
    link: [`https://medium.com/@haris.fadhilah21`,`https://github.com/harisblablabla`,`https://linkedin.com/in/harris-fadhilah/`],
    about: [`In Deutsch?? Hmm hello, I’m Haris Fadhilah you can call me haris/harris, I am livin’ in Jakarta. I really love sports (basketball/football/american football/skate/etc), films, and history! `,
